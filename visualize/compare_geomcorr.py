...
CT_data_new1_nogeo = CT_data('../../team12_new1',is_geo_correct=False)

recon_new1, sinogram_new1 = CT_recon(CT_data_new1)
recon_new1_nogeo, sinogram_new1_nogeo = CT_recon(CT_data_new1_nogeo)
...
plt.xticks([])
plt.yticks([])
plt.xlabel("with geo correction")

plt.subplot(1,2,2)
plt.imshow(recon_new1_nogeo[320],cmap='gray')
plt.xticks([])
plt.yticks([])
plt.xlabel("without geo correction")
plt.show()
plt.savefig("../fig/compare_geo_correction.png")